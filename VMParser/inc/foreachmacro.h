...
#define NTH_ARG(_1, _2, _3, _4, _5, _6, _7, _8, _N, ...) _N

#define FOR_EACH(what, ...) NTH_ARG(__VA_ARGS__, FOR_EACH_8, FOR_EACH_7, FOR_EACH_6, FOR_EACH_5, FOR_EACH_4, FOR_EACH_3,FOR_EACH_2, FOR_EACH_1)(what, __VA_ARGS__)
